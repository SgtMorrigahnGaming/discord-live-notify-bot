...
<script>
  ...
  async function loadGuild(guildId) {
    ...
    const [channels, roles, twitchSubs, youtubeSubs, freeGamesSubs, welcomeConfig, rrPanels, emojis] = await Promise.all([
